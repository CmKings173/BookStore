...
// Ngoài ra note thêm lib này từ docs của MUI nó recommend nếu cần dùng: https://github.com/viclaufouch/mui-file-input
// =====================================================
...
function AccountTab() {
  ...
  // Những thông tin của user để init vào form (key trùng với register phía dưới Field)
  ...
  const submitChangeGeneralInformation = (data) => {
    ...
    // Nếu không có sự thay đổi thì không làm gì cả
  ...
  const uploadAvatar = (e) => {
    // Lấy file thông qua e.target?.files[0] và validate trước khi xử lý
    ...
    // Cách để log được dữ liệu trong FormData
