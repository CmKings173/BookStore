...
// Validation constants & error display
import {
...
function SecurityTab() {
  ...
  const submitChangePassword = (data) => {
    confirmChangePassword({
      // Title, Description, Content,...vv của gói material-ui-confirm đều có type là ReactNode nên có thể
      // thoải mái sử dụng MUI components, rất tiện lợi khi cần custom styles
      ...
      .then(() => {
        ...
        if (new_password_confirmation === new_password) {
          toast.promise(
            ...
            if (!res.error) {
              toast.success('Update successfully! Please login again.')
