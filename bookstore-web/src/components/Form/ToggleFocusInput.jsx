...
// Một Trick xử lý CSS khá hay trong việc làm UI UX khi cần ẩn hiện một cái input: Hiểu đơn giản là
// thay vì phải tạo biến State để chuyển đổi qua lại giữa thẻ Input và Text thông thường thì chúng ta
// sẽ CSS lại cho cái thẻ Input trông như thẻ bình thường, chỉ khi click và focus vào nó thì style lại
// trở về như cái input ban đầu.
// Controlled Input trong MUI: https://mui.com/material-ui/react-text-field/
...
function ToggleFocusInput({ value, onChangedValue, inputFontSize = '16px', ...props }) {
  ...
  const triggerBlur = () => {
    ...
    // Nếu giá trị không có gì thay đổi hoặc Nếu user xóa hết nội dung thì set lại giá trị
    // từ props và return luôn không làm gì thêm
